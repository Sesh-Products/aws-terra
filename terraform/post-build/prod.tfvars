...
lambda_functions = {
  pos_extract = {
    function_name                  = "pos_extract-prod"
    ...
    additional_policy_statements = [
    {
      ...
      resources = ["arn:aws:lambda:us-east-1:000605313601:function:ses-ec2-trigger-prod"]
    },
    {
      effect    = "Allow"
    ...
    },
    {
      ...
      resources = [
        "arn:aws:s3:::pos-pipeline-prod-data",
        "arn:aws:s3:::pos-pipeline-prod-data/*"
      ]
    },
    {
      ...
      resources = [
        "arn:aws:s3:::pos-raw-email-bucket-prod",
        "arn:aws:s3:::pos-raw-email-bucket-prod/*",
        "arn:aws:s3:::pos-processed-email-bucket-prod",
        "arn:aws:s3:::pos-processed-email-bucket-prod/*"
      ]
    }]
    extra_environment_variables = {
      ...
      EC2_TRIGGER_LAMBDA = "ses-ec2-trigger-prod"
      RAW_BUCKET_EMAIL   = "pos-raw-email-bucket-prod"
  ...
  pos_transform = {
    function_name                  = "pos_transform-prod"
    ...
    },
    {
      ...
      resources = [
        "arn:aws:secretsmanager:us-east-1:000605313601:secret:snowflake/pos-pipeline/prod/private-key*",
        "arn:aws:secretsmanager:us-east-1:000605313601:secret:snowflake/pos-pipeline/prod/credentials*"
      ]
    }]
    extra_environment_variables = {
      NOTIFY_EMAIL        = "naimish@seshproducts.com"
      TRANSFORMED_BUCKET  = "pos-processed-email-bucket-prod"
  ...
  ses_ec2_trigger = {
    function_name      = "ses-ec2-trigger-prod"
    ...
    layer_arns         = []
    extra_environment_variables = {
      EC2_INSTANCE_NAME = "nielsen-playwright-prod"
    }
    additional_policy_statements = [
      {
        effect    = "Allow"
...
s3_buckets = {
  s3_bucket_raw = {
    bucket_name                      = "pos-raw-email-bucket-prod"
    force_destroy                    = false
      ...
      lambda_functions = [
        {
          ...
          lambda_arn    = "arn:aws:lambda:us-east-1:000605313601:function:pos_transform-prod"
    ...
    bucket_policy = "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"AllowSESPuts\",\"Effect\":\"Allow\",\"Principal\":{\"Service\":\"ses.amazonaws.com\"},\"Action\":\"s3:PutObject\",\"Resource\":\"arn:aws:s3:::pos-raw-email-bucket-prod/*\"}]}"
  },
  s3_bucket_transformed = {
    bucket_name                      = "pos-processed-email-bucket-prod"
    force_destroy                    = false
    versioning_status                = "Enabled"
    sse_algorithm                    = "AES256"
    kms_master_key_id                = null
    ...
    snowflake_iam_role_name            = "snowflake-pos-email-role-prod"
    snowflake_storage_integration_name = "pos_s3_integration_prod"
    snowflake_database                 = "SESH_METADATA"
    snowflake_schema                   = "STG"
    snowflake_table                    = "STG_POS_UNIFIED_PROD"
    snowflake_stage_name               = "pos_unified_stage_prod"
    snowflake_pipe_name                = "pos_snowpipe_prod"
    snowflake_file_format_name         = "pos_csv_format_prod"
    snowflake_stream_name              = "stg_pos_unified_prod_stream"
...
ec2_instances = {
  nielsen_playwright = {
    instance_name      = "nielsen-playwright-prod"
    instance_type      = "t4g.small"
    s3_script_bucket   = "pos-raw-email-bucket-prod"
...
# SES
# =============================================================================
# SES is a single shared instance managed only by prod.
# Dev sets manage_ses = false and does not touch these resources.

manage_ses              = true
ses_domain              = "data.seshproducts.com"
ses_email_identities    = {
  naimish     = "naimish@seshproducts.com"
  data_ingest = "data-ingest@seshproducts.com"
}
